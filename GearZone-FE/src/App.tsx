...
// Admin pages use AdminLayout internally and must not be inside SiteLayout.
...
// Seller pages use SellerLayout internally and must not be inside SiteLayout.
...
export default function App() {
  return (
    <Routes>
      ...
      />
      <Route
        path="/store-owner/vouchers"
        element={<RequireAuth roles={SELLER_ROLES}><SellerVouchersPage /></RequireAuth>}
      />
      <Route
        path="/store-owner/messages"
        element={<RequireAuth roles={SELLER_ROLES}><SellerMessagesPage /></RequireAuth>}
      />
      <Route
        path="/store-owner/reviews"
        element={<RequireAuth roles={SELLER_ROLES}><SellerReviewsPage /></RequireAuth>}
      />
      <Route
