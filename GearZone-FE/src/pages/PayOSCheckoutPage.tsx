    ...
    <div className="max-w-md mx-auto px-4 py-16 text-center">
      ...
      {payosData.qrCode && (
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6 inline-block w-full">
          ...
          <img src={payosData.qrCode} alt="Payment QR Code" className="w-56 h-56 mx-auto border border-gray-100 rounded-xl object-contain" />
        </div>
      )}
      ...
      <p className="text-xs text-gray-400 mb-5">After completing payment, you will be redirected automatically.</p>
