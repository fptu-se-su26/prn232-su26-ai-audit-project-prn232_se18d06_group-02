# Reflection -- Feature -- Shopping Cart and Checkout
...
The multi-seller checkout required careful thought about what constitutes the order vs sub-order. AI helped clarify the data model. The atomic transaction pattern for order placement prevented partial-order bugs found during testing. Voucher logic had more edge cases than expected.
