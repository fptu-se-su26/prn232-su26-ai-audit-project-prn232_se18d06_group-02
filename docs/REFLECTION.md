# Reflection -- Feature -- Voucher and Discount System
...
The concurrency issue for limited vouchers was a non-obvious edge case. AI flagged it immediately and suggested the optimistic concurrency check within the transaction. The validation rules required multiple iterations to get user-friendly error messages.
