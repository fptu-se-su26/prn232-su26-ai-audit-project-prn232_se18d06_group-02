# Reflection -- Feature -- Authentication and Identity
...
The multi-step registration was more complex than anticipated. AI correctly flagged the need to hash OTPs before storage -- a security requirement that was initially missed. JWT expiry and refresh logic required manual testing to get right.
